...
const (
	...
	IonosCloudClusterReady clusterv1.ConditionType = "ClusterReady" //nolint:staticcheck // Intentionally setting deprecated field for v1beta1 backwards compatibility.
